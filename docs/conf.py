...
edit_on_github_project = "jcapriot/pydata-sphinx-test"
...
if link_github:
    ...
    def linkcode_resolve(domain, info):
        ...
        return f"https://github.com/jcapriot/pydata-sphinx-theme/blob/main/test_package/{fn}{linespec}"
